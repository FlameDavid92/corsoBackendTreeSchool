...
public class Main {
    public static void main(String[] args) {
        TweetsParser tp = new TweetsParser("./it/corsobackendtree/esercizi14/tweetsparser/stopwords.txt");
        TreeMap<Long, List<String>> mostFrequent = tp.mostFrequentWords("./it/corsobackendtree/esercizi14/tweetsparser/realdonaldtrump.csv");
        ...
        mostFrequent = tp.mostFrequentWords("./it/corsobackendtree/esercizi14/tweetsparser/trumptweets.csv");
