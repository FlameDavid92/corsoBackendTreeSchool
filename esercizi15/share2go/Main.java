...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(app.registraUtente("davidefiguccia2020@outlook.it") == false);
        System.out.println(app.registraUtente("marco.com") == false);
        ...
        System.out.println(app.inserisciVettura("BW374PB", Vettura.TipoVettura.AUTOMOBILE,3,80,parcheggioInStrada,prezzo2) == false);
        System.out.println(app.inserisciVettura("AA374564BB", Vettura.TipoVettura.FURGONE,2,100,parcheggioInStrada,prezzo2) == false);
        ...
        System.out.println(app.noleggiaVettura(app.getUtente("chiaragabriele@outlook.com"),app.getVettura("KL256LP"))==false);
        ...
        System.out.println(app.parcheggiaVettura(app.getUtente("davidefiguccia2020@outlook.it"),app.getVettura("BW374PB"),parcheggioConvenzionato)==false);
        System.out.println(app.parcheggiaVettura(app.getUtente("alessioritondo@outlook.com"),app.getVettura("BW374PB"),parcheggioConvenzionato)==false);
        System.out.println();
        ...
        System.out.println(parcheggioConvenzionato.isFull() == false);
        ...
        System.out.println();
        System.out.println(app.getUtente("chiaragabriele@outlook.com").getCredito().getValue().setScale(2, RoundingMode.FLOOR));
